...
public class ItemInfoManager
{
    ...
    private ItemInfo[] informations =
    {
        ...
        new ItemInfo(ItemIdEnum.CARROT_SEED, ImageIdEnum.ITEM_CARROT_SEED, "당근 씨앗", DEFAULT_COUNT, 100, false, 0.0f),
        new ItemInfo(ItemIdEnum.LEMMON_SEED, ImageIdEnum.ITEM_LEMMON_SEED, "레몬 씨앗", DEFAULT_COUNT, 100, false, 0.0f),
        new ItemInfo(ItemIdEnum.RICE_SEED, ImageIdEnum.ITEM_RICE_SEED, "볍씨", DEFAULT_COUNT, 100, false, 0.0f),
        new ItemInfo(ItemIdEnum.TOMATO_SEED, ImageIdEnum.ITEM_TOMATO_SEED, "토마토 씨앗", DEFAULT_COUNT, 100, false, 0.0f),
        new ItemInfo(ItemIdEnum.WATERMELON_SEED, ImageIdEnum.ITEM_WATERMELON_SEED, "수박 씨앗", DEFAULT_COUNT, 100, false, 0.0f),
