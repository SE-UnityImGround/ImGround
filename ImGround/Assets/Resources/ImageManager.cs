...
public class ImageManager
{
    ...
    private ImageInfo[] imageData = {
        ...
        new ImageInfo(ImageIdEnum.ITEM_WATERMELON, "Images/Item2D/Food/한통 수박"),
        ...
        new ImageInfo(ImageIdEnum.ITEM_CARROT, "Images/Item2D/Food/당근"),
        ...
        new ImageInfo(ImageIdEnum.ITEM_RICE_PLANT, "Images/Item2D/seed/벼"),
        new ImageInfo(ImageIdEnum.ITEM_REFINED_RICE, "Images/Item2D/Food/쌀"),

        new ImageInfo(ImageIdEnum.ITEM_HOE, "Images/Item2D/tools/괭이"),
        new ImageInfo(ImageIdEnum.ITEM_RAKE, "Images/Item2D/tools/갈퀴"),
        new ImageInfo(ImageIdEnum.ITEM_PICKAXE, "Images/Item2D/tools/곡괭이"),
        new ImageInfo(ImageIdEnum.ITEM_SHOVEL, "Images/Item2D/tools/삽"),
        new ImageInfo(ImageIdEnum.ITEM_KNIFE, "Images/Item2D/tools/검"),
        new ImageInfo(ImageIdEnum.ITEM_SICKLE, "Images/Item2D/tools/낫"),
        new ImageInfo(ImageIdEnum.ITEM_STRIPED_MARLIN, "Images/Item2D/tools/청새치"),
