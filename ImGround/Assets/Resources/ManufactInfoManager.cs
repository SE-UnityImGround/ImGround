...
{
    private static Dictionary<ManufactCategory, ManufactInfo[]> manufactInfos = new Dictionary<ManufactCategory, ManufactInfo[]>()
    {
        {
            ManufactCategory.SIMPLE_FOOD,
            new ManufactInfo[]
            {
                new ManufactInfo(
                    new ItemBundle[] {
...

        {
            ...
            new ManufactInfo[]
            {
                ...
                new ManufactInfo(
                    new ItemBundle[] {
                        new ItemBundle(ItemIdEnum.MILK_PACK, 4, false)},
                    new ItemBundle(ItemIdEnum.CHEESE, 1, false))
            }
        },

        {
            ManufactCategory.RICE,
            new ManufactInfo[]
            {
                new ManufactInfo(
                    new ItemBundle[] {
...

        {
            ...
            new ManufactInfo[]
            {
                ...
                new ManufactInfo(
                    ...
                    new ItemBundle(ItemIdEnum.COOKED_CHICKEN, 1, false)),
    ...
    public static ManufactInfo[] getManufactInfo(ManufactCategory category)
    {
        return manufactInfos[category];
    }
}
